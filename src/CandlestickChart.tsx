        ...
        const sketch = (p) => {
            ...
            p.setup = () => {
                ...
                chartArea = {
                    ...
                    height: p.windowHeight - topMargin + bottomInset - 60 // raised bottom gridline by 8px
                };
            ...
            p.draw = () => {
                ...
                if (isHistoricalView && p.windowWidth < 768) {
                    ...
                    chartArea.height = p.windowHeight - chartArea.y + bottomInsetHist - 60; // raise bottom gridline in historical view
                }
            ...
            p.windowResized = () => {
                ...
                chartArea = {
                    ...
                    y: topMargin,
                    width: p.windowWidth - leftMargin - rightMargin,
                    height: p.windowHeight - topMargin + bottomInset - 60 // raised bottom gridline by 8px on resize
                };
