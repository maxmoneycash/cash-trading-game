        ...
        const sketch = (p) => {
            ...
            p.setup = () => {
                ...
                chartArea = {
                    ...
                    height: p.windowHeight - topMargin + bottomInset - 20 // Extended grid to include footer area
                };
            ...
            p.draw = () => {
                ...
                if (isHistoricalView && p.windowWidth < 768) {
                    ...
                    chartArea.height = p.windowHeight - chartArea.y + bottomInsetHist - 20; // Extended grid to include footer area in historical view
                }
            ...
            p.windowResized = () => {
                ...
                chartArea = {
                    ...
                    y: topMargin,
                    width: p.windowWidth - leftMargin - rightMargin,
                    height: p.windowHeight - topMargin + bottomInset - 20 // Extended grid to include footer area on resize
                };
